...
const ProductHero = ({ slug }) => {
    ...
    return (
        <>
            <section className="flex sticky top-20 z-50 left-0 justify-around items-center py-3.5 bg-[#181818]">
                ...
                <ul className="flex items-center gap-2 md:gap-4">
                    ...
                    <li>
                        ...
                        /> */}
                        <Modal1
                            styles={"font-inter font-normal px-2 py-1.5 bg-[#FF7F00] hover:!bg-orange-600/70 text-white text-xs md:!text-sm"}
